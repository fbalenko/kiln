...
//     fields → action block → context block (with link back to /deals/<id>)
...
export function buildDealReviewBlocks(
  ...
  const blocks: KnownBlock[] = [
    ...
    {
      type: "actions",
      block_id: `deal_review_actions:${deal.id}`,
      elements: [
        {
          type: "button",
          action_id: "approve",
        ...
        {
          type: "button",
          action_id: "needs_info",
          value: deal.id,
          text: { type: "plain_text", text: "🔍 Needs more info", emoji: true },
        },
      ],
    },
    {
      ...
      elements: [
        {
          type: "mrkdwn",
          text: `Generated by Kiln · <${dealUrl}|view full review>`,
        },
      ],
    },
  ];
